    ...
    public abstract class RecordedBase : WindowPluginBase, IComparer<GUIListItem>
    {
        ...
        protected override void OnShowViews()
        {
            try
            {
                ...
                dlg.Add(Utility.GetLocalizedText(TextId.GroupByTitle));
                dlg.Add(Utility.GetLocalizedText(TextId.GroupBySchedule));
                dlg.Add(Utility.GetLocalizedText(TextId.GroupByCategory));
                dlg.Add(Utility.GetLocalizedText(TextId.GroupByChannel));
                dlg.Add(Utility.GetLocalizedText(TextId.GroupByRecordingDay));
                ...
                switch (dlg.SelectedLabel)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        _currentGroupByMode = RecordingGroupMode.GroupByRecordingDay;
                        break;
                }
        ...
        protected override void LoadSettings()
        {
            ...
            using (Settings xmlreader = new MPSettings())
            {
                ...
                else if (strTmp == "day") _currentGroupByMode = RecordingGroupMode.GroupByRecordingDay;
            ...
            using (Settings xmlwriter = new MPSettings())
            {
                ...
                switch (_currentGroupByMode)
                {
                    ...
                    case RecordingGroupMode.GroupByCategory:
                        ...
                        break;
                    case RecordingGroupMode.GroupByRecordingDay:
                        xmlwriter.SetValue(this.SettingsSection, "group", "day");
                        break;
                }
            }
        }
            ...
            foreach (RecordingGroup recordingGroup in _model.RecordingGroups)
            {
                ...
                if (_currentGroupId == null)
                {
                    if (recordingGroup.RecordingGroupMode != RecordingGroupMode.GroupByChannel
                        ...
                        && recordingGroup.RecordingGroupMode != RecordingGroupMode.GroupByRecordingDay
                    ...
                    || (recordingGroup.RecordingGroupMode == RecordingGroupMode.GroupByRecordingDay && recordingGroup.LatestProgramStartTime == (DateTime)_currentGroupId))
                {
                    recordings = _controller.GetRecordingsForGroup(ControlAgent, groupIndex, true);
                    isSubDirectory = true;
        ...
        {
            if (recordingGroup.RecordingGroupMode == RecordingGroupMode.GroupByRecordingDay)
            {
                return String.Empty;
            }
        ...
        private object CheckValidGroupId(object currentGroupId)
        {
            foreach (RecordingGroup recordingGroup in _model.RecordingGroups)
            {
                if ((recordingGroup.RecordingGroupMode == RecordingGroupMode.GroupBySchedule && currentGroupId is Guid && recordingGroup.ScheduleId == (Guid)currentGroupId)
                    ...
                    || (recordingGroup.RecordingGroupMode == RecordingGroupMode.GroupByRecordingDay && currentGroupId is DateTime && recordingGroup.LatestProgramStartTime == (DateTime)currentGroupId))
                {
                ...
                if (btnViews != null)
                {
                    switch (_currentGroupByMode)
                    {
                        ...
                        case RecordingGroupMode.GroupByCategory:
                            ...
                            break;
                        case RecordingGroupMode.GroupByRecordingDay:
                            text = Utility.GetLocalizedText(TextId.GroupByRecordingDay);
                            break;
                    }
                ...
                else
                {
                    ...
                    switch (recordingGroup.RecordingGroupMode)
                    {
                        ...
                        case RecordingGroupMode.GroupByCategory:
                            ...
                            break;
                        case RecordingGroupMode.GroupByRecordingDay:
                            _currentGroupId = recordingGroup.LatestProgramStartTime;
                            break;
                    }
